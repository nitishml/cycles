...
import { ArrowUpDown, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight, Edit, Ticket } from "lucide-react"
...
export function SevaListTable({ seva, staffRole }: Props) {
    ...
    const data = React.useMemo<SevaListItem[]>(
        () =>
            seva.map(c => ({
                ...c,
            })),
    ...
    const columns: ColumnDef<SevaListItem>[] = [
        {
            accessorKey: "title",
            header: ({ column }) => (
                <Button
        ...
        },
        {
            ...
            header: "Schedule",
            cell: ({ row }) => (
                <span className="">{row.original.schedule}</span>
            ),
        },
            ...
            cell: ({ row }) => (
                <div className="flex items-center justify-end gap-2">
                    <Button variant="view_item" size="sm" className="" asChild>
                        <Link
                            href={`/${redirectRouter}/seva/manage/${row.original.id}`}
                            prefetch={false}>
                    ...
                    <Button variant="view_item" size="sm" className="" asChild>
                        <Link
                            href={`/${redirectRouter}/seva/manage/${row.original.id}/bookings`}
                            prefetch={false}>
