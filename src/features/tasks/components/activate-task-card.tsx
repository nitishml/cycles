...
import { useActivateTask } from "../hooks/use-activate-task";

type Props = {
    taskId: string
}

export function ActivateTaskCard({ taskId }: Props) {
    const mutation = useActivateTask()
        ...
        <AlertDialog>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        This will add the task to the task list and start tracking its cycles
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
