...
export function RoutineListTable({ routines }: Props) {
    ...
    const data = React.useMemo<RoutineListItem[]>(
        () =>
            routines.map(c => ({
                ...c,
            })),
    ...
    const columns: ColumnDef<RoutineListItem>[] = [
        {
            accessorKey: "title",
            header: ({ column }) => (
                <Button
            ...
            cell: ({ row }) => (
                <div className="flex items-center justify-end gap-2">
                    <Button variant="view_item" size="sm" className="" asChild>
                        <Link
                            href={`/routines/manage/${row.original.id}`}
                            prefetch={false}>
                    ...
                    <Button variant="view_item" size="sm" className="" asChild>
                        <Link
                            href={`/routines/manage/${row.original.id}/cycles`}
                            prefetch={false}>
