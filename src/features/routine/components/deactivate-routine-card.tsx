...
import { useDeactivateRoutine } from "../hooks/use-deactivate-routine";
...
export function DeactivateRoutineCard({ routineId }: Props) {
    const mutation = useDeactivateRoutine()
        ...
        <AlertDialog>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        This will remove the routine from the main list and not allow progress
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
